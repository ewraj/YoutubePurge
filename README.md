...
**YouTube Purge** is a Chrome extension that uses local, on-device AI to semantically filter your YouTube feed. It ensures you only see content that aligns with your current learning intent, instantly removing distractions like gaming, food vlogs, and clickbait.
...
- **Hard-Block System**: Built-in protection against common "dopamine loops" like gaming, music mixes, and vlogs.
